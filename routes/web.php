...
Route::get('/fetchclasses',[ClassesController::class,'fetchclasses'])->name('class.fetch');
...
Route::get('/fetchteachers',[TeacherController::class,'fetchteachers'])->name('teacher.fetch');
...
Route::post('/filterStudents',[StudentController::class, 'filterStudents'])->name('filter.students');
...
Route::get('/fetchsubjects',[SubjectController::class, 'fetchSubjects'])->name('subject.fetch');
...
Route::get('/fetchparents',[GuardianController::class, 'fetchParents'])->name('parent.fetch');
