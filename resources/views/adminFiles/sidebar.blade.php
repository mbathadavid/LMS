...
<div class="card">
  ...
  <img src="images/{{ $schoolinfo->logo }}" class=" img-fluid img-thumbnail" alt="">
...
<div class="card-body">
    ...
    <div id="findropdown" class="finances-dropdown d-none w3-animate-zoom">
      <a href="/expenses"><i class="fas fa-angle-right"></i><i class="fas fa-angle-right"></i>&nbsp;Expenses</a>
    ...
    <div id="libdropdown" class="library-dropdown d-none w3-animate-right">
      ...
      <a href="/books"><i class="fas fa-angle-right"></i><i class="fas fa-angle-right"></i>&nbsp;Books</a>
    </div>
