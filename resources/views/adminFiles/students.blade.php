                ...
                success: function(res){
                    ...
                    if (res.classes.length == 0) {
                        ...
                        $.each(res.classes, function(key,item){
                            $('#current_class').append('<option value="'+item.id+','+item.class+' '+item.stream+'">'+item.class+' '+item.stream+'</option>');
                        })
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if (res.classes.length == 0) {
                        ...
                        $.each(res.classes, function(key,item){
                            $('#seditclass').append('<option value="'+item.id+','+item.class+' '+item.stream+'">'+item.class+' '+item.stream+'</option>');
                        })
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if (res.classes.length == 0) {
                        ...
                        $.each(res.classes, function(key,item){
                            $('#nextclass').append('<option value="'+item.id+','+item.class+' '+item.stream+'">'+item.class+' '+item.stream+'</option>');
                        })
                    }
                }
            });
