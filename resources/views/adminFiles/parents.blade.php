                ...
                success: function(res){
                    if (res.classes.length == 0) {
                        ...
                        $.each(res.classes, function(key,item){
                            $('#studentfilter').append('<option value="'+item.class+' '+item.stream+'">'+item.class+' '+item.stream+'</option>');
                        })
                    }
                }
            });
            ...
            $.ajax({
                ...
                success: function(res){
                    if (res.classes.length == 0) {
                        ...
                        $.each(res.classes, function(key,item){
                            $('#editstudentfilter').append('<option value="'+item.class+' '+item.stream+'">'+item.class+' '+item.stream+'</option>');
                        })
                    }
                }
            });
